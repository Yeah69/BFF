...
namespace BFF.Persistence.Import
{
    ...
    //{
    //    private readonly IExportingOrm _importingOrm;
    ...
    //    {
    //        DictionaryExtensions.AddToKey(_payeeAssignment, GetOrCreatePayee(name), transBase);
    //    }
    ...
    //    {
    //        DictionaryExtensions.AddToKey(_flagAssignment, GetOrCreateFlag(name), transBase);
    //    }
