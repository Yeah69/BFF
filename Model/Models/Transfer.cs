    ...
    public  abstract class Transfer : TransBase, ITransfer
    {
        ...
        public IAccount? FromAccount
        {
            ...
            set
            {
                ...
                if (value is not null && (_toAccount == value || _toAccount is null)) // If value equals ToAccount, then the FromAccount and ToAccount switch values
                {
        ...
        public IAccount? ToAccount
        {
            ...
            set
            {
                ...
                if (value is not null && (_fromAccount == value || _fromAccount is null)) // If value equals ToAccount, then the FromAccount and ToAccount switch values
                {
