...
namespace BFF.View.Wpf.DropHandler
{
    ...
    {
        private static readonly Lazy<MergingFlagViewModelsDropHandler> Lazy = new(() => new MergingFlagViewModelsDropHandler(), LazyThreadSafetyMode.ExecutionAndPublication);
