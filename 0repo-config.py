...
REPOSITORY_BASE_URL = "https://yeah69.github.io/BFF/0install/"
...
GPG_SIGNING_KEY = None if os.getenv('NO_SIGN') else "0xD896485298D2665546CFEECF7088B043B0079B70"
...
# managed by 0repo.
ARCHIVES_BASE_URL = "https://github.com/Yeah69/BFF/releases/download/"
...
def get_archive_rel_url(archive_basename, impl):
	...
	return "v{version}/{archive}".format(
